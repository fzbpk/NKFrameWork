...
namespace NK.Data
{
    public partial class Access : IDisposable, iDataBase
    {
        ...
        public Access(string connection = "", int Timeouts = 60)
        {
        ...
        public Access(DbConnection Connection)
        { 
            if (Connection != null)
            {
                DBConn = Connection;
