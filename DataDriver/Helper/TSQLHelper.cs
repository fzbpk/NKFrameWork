...
namespace NK.Data
{
    ...
    { 
                ...
                foreach (var tmp in Column)
                {
                    ...
                    else
                    {
                        ...
                        if (t == typeof(string))
                        {
                            ...
                            Val += ",'" +Convert.ToDateTime(tmp.Value).ToString("yyyy-MM-dd HH:mm:ss") + "'";
                        else if (t == typeof(bool))
                        {
                            if ((bool)tmp.Value)
                            {
                ...
                foreach (var tmp in Column)
                {
                    ...
                    else
                    {
                        ...
                        if (t == typeof(string))
                            ...
                            ColVal += "'" + Convert.ToDateTime(tmp.Value).ToString("yyyy-MM-dd HH:mm:ss") + "'";
                        else if (t == typeof(bool))
                        {
                            if ((bool)tmp.Value)
                                ColVal += "1";
        ...
        /// <param name="TableName">表名</param>
        /// <returns>T-SQL</returns>
        public static string DropToSql(this string TableName)
        {
            if (string.IsNullOrEmpty(TableName)) return "";
