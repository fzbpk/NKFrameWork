...
namespace NK.Data
{
    ...
    /// ODBC
    /// </summary>
    public partial class ODBC : DbConnectionHelper, IDisposable, iDataBase
    {
        ...
        public ODBC(DBInfo info):base(info)
        {
            dy = DBType.SQLite;
            ClassName = this.GetType().ToString();
        }
        public ODBC(string connection = "", int Timeouts = 60) : base(connection, Timeouts)
        {
            dy = DBType.SQLite;
            ClassName = this.GetType().ToString();
        }

        public ODBC(DbConnection Connection) : base(Connection)
        {
            dy = DBType.SQLite;
            ClassName = this.GetType().ToString();
        }
        ...
        public DbConnection GetConnection()
        {
            ...
            try
            {
                OdbcConnection conn = new OdbcConnection(this.Connection);
                return conn;
            }
            catch (Exception ex)
            {
        ...
        public DataTable getDataTableByRam(int PageIndex, int PageSize, string DisplayField, string TableName, string Where, string OrderBy, string GroupBy, out int RecodeCount, out int PageCount)
        {
            ...
            try
            {
                ...
                da.SelectCommand.Connection = (OdbcConnection)Conn;
        ...
        public List<string> Tables
        {
            get
            {
                ...
                try
                {
                    init();
                    DataTable dt = null;
                    OdbcConnection conn = (OdbcConnection)Conn;
