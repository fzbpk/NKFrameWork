...
namespace NK.Data
{
    ...
    /// PostgreSQL
    /// </summary>
    public partial class PostgreSQL : DbConnectionHelper, IDisposable, iDataBase
    {
        ...
        public PostgreSQL(DBInfo info):base(info)
        {
            dy = DBType.SQLite;
            ClassName = this.GetType().ToString();
        }
        public PostgreSQL(string connection = "", int Timeouts = 60) : base(connection, Timeouts)
        {
            dy = DBType.SQLite;
            ClassName = this.GetType().ToString();
        }
        ...
        public DbConnection GetConnection()
        {
            ...
            try
            {
                NpgsqlConnection conn = new NpgsqlConnection(this.Connection);
                return conn;
            }
            catch (Exception ex)
            {
        ...
        public DataTable getDataTableByRam(int PageIndex, int PageSize, string DisplayField, string TableName, string Where, string OrderBy, string GroupBy, out int RecodeCount, out int PageCount)
        {
            ...
            try
            {
                ...
                da.SelectCommand.Connection = (NpgsqlConnection)Conn;
        ...
        public List<string> Tables
        {
            get
            {
                ...
                try
                {
                    init();
                    DataTable dt = null;
                    NpgsqlConnection conn = (NpgsqlConnection)Conn;
