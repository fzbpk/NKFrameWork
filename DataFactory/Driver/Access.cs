...
namespace NK.Data
{
    ...
    /// Access
    /// </summary>
    public partial class Access : DbConnectionHelper, IDisposable, iDataBase
    {
        ...
        public Access(DBInfo info):base(info)
        {
            dy = DBType.SQLite;
            ClassName = this.GetType().ToString();
        }
        public Access(string connection = "", int Timeouts = 60) : base(connection, Timeouts)
        {
            dy = DBType.SQLite;
            ClassName = this.GetType().ToString();
        }

        public Access(DbConnection Connection) : base(Connection)
        {
            dy = DBType.SQLite;
            ClassName = this.GetType().ToString();
        }
        ...
        public DbConnection GetConnection()
        {
            ...
            try
            {
                OleDbConnection conn = new OleDbConnection(this.Connection);
                return conn;
            }
            catch (Exception ex)
            {
        ...
        public List<string> Tables
        {
            get
            {
                ...
                try
                {
                    init();
                    DataTable dt = null;
                    OleDbConnection conn = (OleDbConnection)Conn;
