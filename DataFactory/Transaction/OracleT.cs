...
namespace NK.Data
{
    ...
    /// Oracle事务
    /// </summary>
    internal partial class OracleT : IDisposable,iTransaction
    {
        ...
        private OracleConnection STConn = null;
        private OracleTransaction ST = null;
        ...
        public OracleT(string connection = "", int Timeouts = 60)
        {
        ...
        public OracleT(DbConnection Connection)
        { 
            if (Connection != null)
            {
                STConn = Connection as OracleConnection;
        ...
        public void ExecuteNonQuery(string sql)
        {
            try
            {
                ...
                OracleCommand cmd = STConn.CreateCommand();
        ...
        public bool TableIsExist(string TableName)
        {
            ...
            try
            {
                ...
                cmd.Connection = STConn;
                cmd.Transaction = ST;
                cmd.CommandText = "SELECT COUNT(*) FROM USER_OBJECTS WHERE UPPER(OBJECT_NAME)='" + TableName.ToUpper() + "'"; 
                cmd.CommandTimeout = this.Timeout * 1000;
        ...
        public void Transaction()
        {
            try
            {
                ...
                STConn = new OracleConnection(this.Connection);
