...
namespace NK.Data
{
    ...
    /// SQLite事务
    /// </summary>
    internal partial class SQLiteT : IDisposable,iTransaction
    {
        ...
        private SQLiteConnection STConn = null;
        private SQLiteTransaction ST = null;
        ...
        public SQLiteT(string connection = "", int Timeouts = 60)
        {
        ...
        public SQLiteT(DbConnection Connection)
        { 
            if (Connection != null)
            {
                STConn = Connection as SQLiteConnection;
        ...
        public void ExecuteNonQuery(string sql)
        {
            try
            {
                ...
                SQLiteCommand cmd = STConn.CreateCommand();
        ...
        public void Transaction()
        {
            try
            {
                ...
                STConn = new SQLiteConnection(this.Connection);
