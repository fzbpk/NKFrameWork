...
namespace NK.Data
{
    ...
    /// MySQL事务
    /// </summary>
    internal partial class MySQLT : IDisposable, iTransaction
    {
        ...
        private MySqlConnection STConn = null;
        private MySqlTransaction ST = null;
        ...
        public MySQLT(string connection = "", int Timeouts = 60)
        {
        ...
        public MySQLT(DbConnection Connection)
        { 
            if (Connection != null)
            {
                STConn = Connection as MySqlConnection;
        ...
        public void ExecuteNonQuery(string sql)
        {
            try
            {
                ...
                MySqlCommand cmd = STConn.CreateCommand();
        ...
        public bool TableIsExist(string TableName)
        {
            ...
            try
            {
                ...
                cmd.Connection = STConn;
                cmd.Transaction = ST;
                cmd.CommandText = "select count( * ) FROM information_schema.TABLES WHERE table_name = '" + TableName + "' AND TABLE_SCHEMA = '" + STConn.Database + "'";  
                cmd.CommandTimeout = this.Timeout * 1000;
        ...
        public void Transaction()
        {
            try
            {
                ...
                STConn = new MySqlConnection(this.Connection);
