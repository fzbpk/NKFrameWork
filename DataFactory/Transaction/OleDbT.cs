...
namespace NK.Data
{
    ...
    ///  Ole事务
    /// </summary>
    internal partial class OleDbT : IDisposable,iTransaction
    {
        ...
        public OleDbT(string connection = "", int Timeouts = 60)
        {
        ...
        public OleDbT(DbConnection Connection)
        { 
            if (Connection != null)
            {
