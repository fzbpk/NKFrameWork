...
namespace NK.Data
{
    ...
    /// ODBC事务
    /// </summary>
    internal partial class ODBCT : IDisposable,iTransaction
    {
        ...
        private OdbcConnection STConn = null;
        private OdbcTransaction ST = null;
        ...
        public ODBCT(string connection = "", int Timeouts = 60)
        {
            this.Connection = connection;
            this.Timeout = Timeouts;
            ClassName = this.GetType().ToString();
        }
        public ODBCT(DbConnection Connection)
        { 
            if (Connection != null)
            {
                STConn = Connection as OdbcConnection;
        ...
        public void  ExecuteNonQuery(string sql)
        {
            try
            {
                ...
                OdbcCommand cmd = STConn.CreateCommand();
        ...
        public void Transaction()
        {
            try
            {
                ...
                STConn = new OdbcConnection(this.Connection);
