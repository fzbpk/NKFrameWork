...
namespace UIWeb.Entity
{
    ...
    [ToolboxData("<{0}:IPInfoUI runat='server'   ></{0}:IPInfoUI>")]
    public class IPInfoUI : Control, IPostBackDataHandler
    {
        ...
        public IPInfo Entity
        {
            get
            {
                ...
                if (string.IsNullOrEmpty(json))
                    ...
                    return json.Deserialize<IPInfo>();
            }
            set
            { Info = value; }
        }
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            string HTML = UIHelper.EntityToForm<IPInfo>(pls, this.UniqueID, LineCSS, HeadCSS, ValueCSS, TextBoxCSS, ComBoxCSS, TimeCSS, CheckBoxCSS);
            writer.Write(HTML);
        }
        ...
        {
            bool res = true;
            Info = UIHelper.FormToEntity<IPInfo>(postDataKey, postCollection, out Errmsg);
