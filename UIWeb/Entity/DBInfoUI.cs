...
namespace UIWeb.Entity
{
    ...
    [ToolboxData("<{0}:DBInfoUI runat='server'   ></{0}:DBInfoUI>")]
    public class DBInfoUI: Control, IPostBackDataHandler
    {
       ...
       public DBInfo Entity {
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            string HTML= UIHelper.EntityToForm<DBInfo>(pls, this.UniqueID, LineCSS, HeadCSS, ValueCSS, TextBoxCSS, ComBoxCSS, TimeCSS, CheckBoxCSS);
            writer.Write(HTML); 
        }
        ...
        {
            bool res = true;
            Info = UIHelper.FormToEntity<DBInfo>(postDataKey, postCollection, out Errmsg );
