...
namespace NK.Interface
{
    ...
    public  interface iDataBase
    {
        ...
        /// <param name="TableName">表名</param>
        /// <returns>查询结果</returns>
        DataTable getDataTable(string sql, int PageIndex, int PageSize, out int RecCount, out int PageCount, string TableName = "Query");
        ...
        /// <param name="TableName">表名</param>
        /// <returns></returns>
        Dictionary<ColumnAttribute, Type> Columns(string TableName);
        ...
        CommEvent.LogEven log { get; set; }
        DBEvent.Connect Connect { get; set; }
        DBEvent.DisConnect DisConnect { get; set; }
